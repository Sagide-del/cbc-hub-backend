...
export interface ApiDiyProjectDiyProject extends Struct.CollectionTypeSchema {
  collectionName: 'diy_projects';
  info: {
    displayName: 'DIY PROJECT ';
    pluralName: 'diy-projects';
    singularName: 'diy-project';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::diy-project.diy-project': ApiDiyProjectDiyProject;
